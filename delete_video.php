...
<header id="home">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="title">
             <h1>welcome in the delete of video  course page</h1>
...
if (isset($_POST["submit"])) {
    ...
    $result_info = mysqli_query($conn, "SELECT * FROM mytable WHERE course = $selectedValue1 ");

    // Loop through the results
    while ($row = mysqli_fetch_assoc($result_info)) {
        ?>
        <form method="POST" action="">
        <video controls muted loop style="width: 300px; height: 400px;">
