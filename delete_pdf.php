...
<header id="home">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="title">
             <h1>welcome in the delete of book from course page</h1>
...
<form method="post" action="">
    ...
    if (isset($_POST["submit"])) {
        ...
        $result_pdf = mysqli_query($conn, "SELECT * FROM pdf WHERE course = $selectedValue1 ");
    ...
    ?>
        <div class="course">
            ...
            <button type="submit" name="submit2" value="<?php echo $row['id']; ?>" class="btn btn-primary">delete</button>
        </div>
    <?php
            }
        }
